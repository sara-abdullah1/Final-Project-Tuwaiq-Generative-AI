...
2. **Text-to-Speech**:
   - Converts Arabic poems to speech using the [**MBZUAI/speecht5_tts_clartts_ar**](https://huggingface.co/MBZUAI/speecht5_tts_clartts_ar) model.
...
4. **Text-to-Image**:
   - Generates an image using the [**runwayml/stable-diffusion-v1-5**](https://huggingface.co/runwayml/stable-diffusion-v1-5) model.
